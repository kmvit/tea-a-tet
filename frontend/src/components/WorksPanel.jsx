...
// Показывается справочно: расценки и время НЕ входят в стоимость заказа.
  ...
  return (
    <div className={`rounded-lg bg-gray-50 border border-gray-200 p-4 ${className}`}>
      <div className="flex items-center justify-between mb-2">
        <h4 className="text-sm font-semibold text-gray-700">Работы (справочно)</h4>
        <span className="text-xs text-gray-400">не входят в стоимость</span>
      </div>
