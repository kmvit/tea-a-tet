...
SECRET_KEY = os.getenv(
    'SECRET_KEY',
    'django-insecure-$9w427c+yxiqt9x8ig0df8bptm1&i*y9@7q_jw4&zb)!y6qo7o'
)
...
_db_path = os.getenv('DATABASE_PATH', 'db.sqlite3')
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.sqlite3',
        'NAME': str(BASE_DIR / _db_path) if not os.path.isabs(_db_path) else _db_path,
    }
}
